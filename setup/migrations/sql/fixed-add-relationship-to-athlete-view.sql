-- Fix for adding relationship_to_athlete field to athletes_with_waiver_status view
-- This corrects the previous script that referenced non-existent tables
...
SELECT 
  ...
  -- Get the signer's name from parents table
  CONCAT(p.first_name, ' ', p.last_name) as waiver_signer_name,
  -- Add relationship_to_athlete field from the waivers table
  w.relationship_to_athlete as waiver_relationship_to_athlete,
