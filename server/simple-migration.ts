import { db } from './db';
import { blogPosts, tips } from '@shared/schema';

async function addSampleContent() {
  console.log('Adding sample content if database is empty...');

  // Check if we need to add sample blog posts
...
Remember: we're not just teaching gymnastics skills—we're building confident, resilient young people who know they can face any challenge with courage and determination.`,
        excerpt: "Every gymnastics journey begins with a single step, and at Coach Will's Adventure Academy, we believe that confidence grows through celebrating the small victories along the way.",
        category: "motivation",
...
Remember: we're not just building gymnasts—we're building young people who know that every expert was once a beginner, and every success story includes chapters of struggle and growth.`,
        excerpt: "At Coach Will's Adventure Academy, we've discovered something remarkable: the athletes who embrace their mistakes are the ones who soar the highest.",
        category: "training",
...
Remember: We're building lifelong healthy relationships with food, not strict dietary rules. Focus on nourishing the body to support their gymnastics adventures and overall well-being.`,
        excerpt: "Just as a car needs the right fuel to run efficiently, young gymnasts need proper nutrition to power their training and support their growth.",
        category: "health",
  ...
  // Check if we need to add sample tips
...
Remember: The back handspring is an advanced skill that requires patience, preparation, and proper coaching. Focus on building a strong foundation through drills and prerequisite skills. When you're ready, this amazing skill will come together naturally!`,
  ...
  console.log(`Tips: ${counts[1]}`);
  console.log('Sample content setup complete!');
}

// Execute the content setup
