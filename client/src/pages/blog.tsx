    ...
    <div className="min-h-screen theme-smooth bg-gradient-to-b from-[#D8BD2A]/10 via-white to-[#0F0276]/5 dark:from-[#0F0276]/40 dark:via-[#0F0276]/20 dark:to-black">
              ...
              <div className="space-y-8 sticky top-8">
                ...
                <Card className="p-6 glass-surface glass-card glass-gradient border border-slate-200 dark:border-slate-700">
                  ...
                  <Select value={sortOrder} onValueChange={(value: "newest" | "oldest") => setSortOrder(value)}>
                    <SelectTrigger className="w-full hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors duration-200">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <Badge 
                        ...
                        className={selectedCategory === "all" ? "bg-purple-600 text-white dark:bg-purple-500 dark:text-white" : ""}
                      >
                      ...
                      .map(([category, count]) => (
                        ...
                        >
                          ...
                          <Badge 
                            ...
                            className={selectedCategory === category ? "bg-purple-600 text-white dark:bg-purple-500 dark:text-white" : ""}
                          >
                            {count}
                          </Badge>
                        </div>
                ...
                <Card className="p-6 glass-surface glass-card glass-gradient border border-slate-200 dark:border-slate-700">
                  ...
                  {subscriptionMessage && (
                    <div className="mb-4 p-3 rounded-lg bg-green-50 dark:bg-emerald-900/20 border border-green-200 dark:border-emerald-800">
                      <div className="flex items-center">
                        <CheckCircle className="h-4 w-4 text-green-600 dark:text-emerald-300 mr-2" />
                  ...
                  {authStatus?.loggedIn ? (
                    ...
                    <div className="space-y-3">
                      ...
                      {parentOptInMutation.isPending && (
                        <p className="text-xs text-purple-600 dark:text-purple-300">Updating preference...</p>
                      )}
                    </div>
                  ) : (
      ...
      <p className="text-slate-700 dark:text-slate-300">
        ...
        className="text-xs text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200"
                ...
                <Badge 
                  variant="secondary" 
      className={`text-xs ${sortOrder === "newest" ? "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-200" : "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-200"}`}
                >
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <Badge 
                            ...
                            className={`text-xs px-2 py-1 rounded-full font-medium ${
                              post.category === 'Tips' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200' :
                              post.category === 'Story' ? 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-200' :
                  ...
                  {posts && posts.length > 0 ? (
                    ...
                    <div className="max-w-md mx-auto">
                      <div className="bg-orange-100 dark:bg-orange-900/30 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                        <Search className="h-8 w-8 text-orange-600 dark:text-orange-300" />
                      </div>
