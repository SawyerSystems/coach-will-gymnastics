      ...
      <main className="max-w-5xl mx-auto py-8 px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      const count = (data.skills as any[]).filter((s: any) => ((s.athleteSkill?.status || '') as string).toLowerCase() === key).length;
                      return (
          ...
          <Card className="bg-white shadow-sm border-0">
            ...
            <CardContent>
              {(data.skills as any[]).filter((s: any) => ((s.athleteSkill?.status || '') as string).toLowerCase() === 'mastered').slice(0, 3).map((s: any) => (
              ...
              {(data.skills as any[]).filter((s: any) => ((s.athleteSkill?.status || '') as string).toLowerCase() === 'mastered').length === 0 && (
