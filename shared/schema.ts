// Archived bookings table for audit/history
...
export type ArchivedBooking = typeof archivedBookings.$inferSelect;
export type InsertArchivedBooking = typeof archivedBookings.$inferInsert;
